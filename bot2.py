...
def bot2_move(bot_position, captain_position, alien_positions, ship_layout):
    # This function should re-calculate the path at every call, considering alien positions.
    # Placeholder for pathfinding logic
    next_step = bot_position  # Calculate the next step based on updated path
    return next_step
