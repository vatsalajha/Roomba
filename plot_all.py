...
combined_data = pd.merge(bot1_data, bot2_data, on='K', suffixes=('_bot1', '_bot2'))
...
plt.figure(figsize=(10, 6))
sns.lineplot(data=combined_data, x='K', y='Survival Rate_bot1', label='Bot 1')
sns.lineplot(data=combined_data, x='K', y='Survival Rate_bot2', label='Bot 2')
sns.lineplot(data=combined_data, x='K', y='Survival Rate_bot3', label='Bot 3')
